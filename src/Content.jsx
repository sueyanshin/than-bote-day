  ...
  return (
    <div className="sm:w-3/4 sm:mt-14 mt-20 ">
        ...
        {data[currentContentIndex].content.map((item, index) => {
          return (
            <p
              ...
              className={
                index % 2 !== 0
                  ? "sm:text-lg pb-3 text-gray-400 text-xs"
                  : "sm:text-2xl"
              }
            >
              {item}
      ...
      <div className="flex justify-around mx-4 ">
        <button
          className=" border border-white rounded-full  w-10 h-10 shadow-lg  hover:bg-violet-900"
          onClick={handlePrevious}
        >
          &#8592;
        </button>
        <button
          className=" border border-white rounded-full shadow-lg w-10 h-10 hover:bg-violet-900"
          onClick={handleNext}
        >
          &rarr;
        </button>
